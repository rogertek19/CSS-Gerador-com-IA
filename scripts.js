...
let chave = process.env.GROQ_API_KEY
let endereco = "https://api.groq.com/openai/v1/chat/completions"
let textoTeste = document.querySelector(".caixa-texto")

textoTeste.addEventListener('input', function() {
    // CORREÇÃO 2: Agora usamos textoUsuario.value aqui dentro
    botao.disabled = textoTeste.value.trim() === '';
});

// Criei a função que será chamada quando clicar
// no botão
...
textoTeste.addEventListener("keydown", function(event) {
...
// Ficar de olho no botão, quando clicado chamar o gerarCodigo
